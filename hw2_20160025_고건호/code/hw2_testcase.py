...
def hw2_testcase():
    ...
    identity_image = my_filter2D(test_image, identity_filter, mode="reflect")
    ...
    blur_image = my_filter2D(test_image, blur_filter, mode="reflect")
    ...
    large_blur_image = my_filter2D(test_image, large_1d_blur_filter, mode="reflect")
    large_blur_image = my_filter2D(large_blur_image, large_1d_blur_filter.T, mode="reflect")  # notice the transpose operator
    ...
    sobel_image = my_filter2D(test_image, sobel_filter, mode="reflect")
    ...
    laplacian_image = my_filter2D(test_image, laplacian_filter, mode="reflect")
